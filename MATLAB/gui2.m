...
% Last Modified by GUIDE v2.5 24-Jun-2020 13:35:04
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
a=get(handles.rbutton,'SelectedObject');
b=get(a,'string');
c=str2double(b);
switch c
    case 1
        set(handles.text3,'string','20');
    case 2
        set(handles.text3,'string','30');
    case 3
        set(handles.text3,'string','40');
end
...
% --- Executes during object creation, after setting all properties.
function rbutton_CreateFcn(hObject, eventdata, handles)
% hObject    handle to rbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
